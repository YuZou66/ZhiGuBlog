window.onload = function() {
    ...
    g_btmbar.innerHTML =
        ...
        <div class="wrap" id="g_player" style="margin-left: -498.5px;">
            ...
            <div class="head j-flag"><img id="musicImg" src="./images/bgm.jpg">
...
var musicImgList = ['./images/bgm.jpg', './images/bg2.jpg', './images/bg3.jpg'];
var nowMusic = 0;
//添加多个歌曲
function pushMusicList(objArr) {
    if (objArr.length != 0) {
        for (const index in objArr) {
            ...
            musicImgList.push(objArr[index].musicCover || './images/bgm.jpg');
...
function pushMusic(obj) {
    if (obj) {
        ...
        musicImgList.push(obj["musicCover"] || './images/bgm.jpg');
...
function replaceCover(path) {
    ...
    path = path == undefined ? './images/bgm.jpg' : path;
